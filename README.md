...
- Ubuntu:<br>
`sudo apt install python3 python3-pip python3-dev python3-venv python3-tk libmpv2 libayatana-appindicator3-1 gir1.2-ayatanaappindicator3-0.1 libgirepository-2.0-dev gcc libcairo2-dev pkg-config gir1.2-gtk-4.0`
- Fedora:<br>
...
- openSUSE:<br>
`sudo zypper in python3 python3-pip python3-devel python3-tk libmpv2 libappindicator3-1 typelib-1_0-AyatanaAppIndicator3-0_1 cairo-devel pkg-config gcc gobject-introspection-devel`
...
![Image of VisorPop's tray icon on Windows](readme-images/1.0.1_tray_icon.png)
...
As of version 1.0.1, replies to Walltaker posts can be sent using the client.<br>
Use the Reply button on either the main menu or tray icon to reply to the last pop-up you recieved. Your Walltaker API key is required to send replies.
